...
public class ResponseExtractor {
    ...
    public static Response toResponse(int statusCode , InputStream inputStream , String resultCharset , MultiValueMap<String , String> headers) throws IOException{
        byte[] bodyBytes = extractBytes(statusCode, inputStream, resultCharset, headers);
        return toResponse(statusCode, bodyBytes, resultCharset, headers);
    }

    public static Response toResponse(int statusCode, byte[] bodyBytes, String resultCharset, MultiValueMap<String, String> headers) {
