...
abstract class AbstractParameterHandler<P>{
    ...
    /**
     * 处理header的
     * @see top.jfunc.http.annotation.Header
     */
    ...
    /**
     * 处理headerMap的
     * @see top.jfunc.http.annotation.HeaderMap
     */
    ...
    /**
     * 处理查询参数的
     * @see top.jfunc.http.annotation.Query
     */
    ...
    /**
     * 处理headerMap的
     * @see top.jfunc.http.annotation.QueryMap
     */
    ...
    /**
     * 处理Part
     * @see top.jfunc.http.annotation.Part
     */
    ...
    /**
     * 处理field的
     * @see top.jfunc.http.annotation.Field
     */
    ...
    /**
     * 处理fieldMap的
     * @see top.jfunc.http.annotation.FieldMap
     */
    ...
    /**
     * 处理Body的
     * @see top.jfunc.http.annotation.Body
     */
    ...
    /**
     * 处理请求URL的
     * @see top.jfunc.http.annotation.Url
     */
